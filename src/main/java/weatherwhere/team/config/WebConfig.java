...
*/
    ...
    public void addInterceptors(InterceptorRegistry registry){
        ...
        registry.addInterceptor(new LoginCheckInterceptor())
                .order(2)
                .addPathPatterns("/**")
                .excludePathPatterns("/", "/login", "/members/join", "/logout", "/css/**", "/*.ico", "/error", "/region/insert", "/img/**", "/js/**","/region/weather/**","/region/api/**", "/members/memberIdChk", "/members/findId","/schedule","/schedule/add","/schedule/edit/**","/schedule/find/**");
    }
